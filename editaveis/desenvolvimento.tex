...
Alternativa de solução: adquirir um quadro comum no comércio e realizar as adaptações necessárias.
	...
	Com o objetivo de viabilizar o projeto já descrito acima foram feitos os gastos listados na Tabela \ref*{custo_dos_materiais_da_estrutura}:
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.8\textwidth]{quadro_original_lateral.jpg}
