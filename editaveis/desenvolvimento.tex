...
\newpage
	...
	\begin{table}[H]
		...
		\begin{tabular}{|M{6cm} | M{3,5cm} |}
			...
			6 abraçadeiras de 1’’ & \\
			\hline
			100 parafusos de 3,5x30mm & \\
			\hline
			30 parafusos de 3x12mm & \\
			\hline
			2 lixas para madeira Nº 120 & \\
			\hline
...
\textbf{FOTOS DA CAIXA E DA BICICLETA}
		\begin{comment}
		\graphicspath{{figuras/}}	
		\begin{figure}[h!]
		\centering
